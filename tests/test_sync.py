...
def test_search(httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&text=%s' % (SearchClient.BASE_URL, request),
        json=expected,
    )
...
def test_search_with_lang_type(httpx_mock: HTTPXMock):
    request = 'Car service, Moscow, 2 Vyazovsky proezd 4a'
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=tr_TR&apikey=api_key&text=%s&type=biz' % (SearchClient.BASE_URL, request),
        json=expected,
    )
...
def test_search_with_ll_spn(httpx_mock: HTTPXMock):
    request = 'Car service, Moscow, 2 Vyazovsky proezd 4a'
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&text=%s&ll=37.61892,55.756994&spn=0.552069,0.400552' % (SearchClient.BASE_URL, request),
        json=expected,
    )
    actual = SearchClient('api_key').search(request, **params)
    assert actual == expected
...
def test_search_with_bbox(httpx_mock: HTTPXMock):
    request = 'Car service, Moscow, 2 Vyazovsky proezd 4a'
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&text=%s&bbox=36.83,55.67~38.24,55.91' % (SearchClient.BASE_URL, request),
        json=expected,
    )
    actual = SearchClient('api_key').search(request, **params)
    assert actual == expected
...
def test_search_with_rspn_results_skip(httpx_mock: HTTPXMock):
    request = 'Car service, Moscow, 2 Vyazovsky proezd 4a'
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&text=%s&rspn=1&results=10&skip=10' % (SearchClient.BASE_URL, request),
        json=expected,
    )
    actual = SearchClient('api_key').search(request, **params)
    assert actual == expected
...
def test_search_with_all(httpx_mock: HTTPXMock):
    request = 'Car service, Moscow, 2 Vyazovsky proezd 4a'
    params = {
...
def test_geocode(httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&format=json&geocode=%s' % (GeocodeClient.BASE_URL, request),
        json=expected,
    )
...
def test_geocode_with_lang_sco_kind_rspn(httpx_mock: HTTPXMock):
    request = 'Moscow, Novy Arbat street, 24'
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=tr_TR&apikey=api_key&geocode=%s&format=json&sco=latlong&kind=metro&rspn=1' % (GeocodeClient.BASE_URL, request),
        json=expected,
    )
...
def test_geocode_with_ll_spn(httpx_mock: HTTPXMock):
    request = 'Moscow, Novy Arbat street, 24'
    params = {'ll': [37.61892, 55.756994], 'spn': [0.552069, 0.400552]}
    expected = {'request': request, 'params': params}
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&geocode=%s&format=json&ll=37.61892,55.756994&spn=0.552069,0.400552' % (GeocodeClient.BASE_URL, request),
        json=expected,
    )
    actual = GeocodeClient('api_key').geocode(request, **params)
    assert actual == expected
...
def test_geocode_with_bbox(httpx_mock: HTTPXMock):
    request = 'Moscow, Novy Arbat street, 24'
    params = {'bbox': [36.83, 55.67, 38.24, 55.91]}
    expected = {'request': request, 'params': params}
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&geocode=%s&format=json&bbox=36.83,55.67~38.24,55.91' % (GeocodeClient.BASE_URL, request),
        json=expected,
    )
    actual = GeocodeClient('api_key').geocode(request, **params)
    assert actual == expected
...
def test_geocode_with_rspn_results_format_results_skip(httpx_mock: HTTPXMock):
    request = 'Moscow, Novy Arbat street, 24'
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&geocode=%s&format=xml&results=10&skip=10' % (GeocodeClient.BASE_URL, request),
        json=expected,
    )
    actual = GeocodeClient('api_key').geocode(request, **params)
    assert actual == expected
...
def test_geocode_with_all(httpx_mock: HTTPXMock):
    request = 'Moscow, Novy Arbat street, 24'
    params = {
    ...
    httpx_mock.add_response(
        ...
        (GeocodeClient.BASE_URL, request),
        json=expected,
    )
    actual = GeocodeClient('api_key').geocode(request, **params)
    assert actual == expected
...
def test_reverse(httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        method='GET',
        url='%s?lang=ru_RU&apikey=api_key&format=json&geocode=%s' % (GeocodeClient.BASE_URL, f'{request[0]},{request[1]}'),
        json=expected,
    )
...
def test_reverse_with_sco_lang_kind_rspn(httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        ...
        (GeocodeClient.BASE_URL, f'{request[0]},{request[1]}'),
        json=expected,
    )
...
def test_reverse_with_ll_spn(httpx_mock: HTTPXMock):
    request =  [37.611347, 55.760241]
    params = {'ll': [37.61892, 55.756994], 'spn': [0.552069, 0.400552]}
    expected = {'request': request, 'params': params}
...
def test_reverse_with_bbox(httpx_mock: HTTPXMock):
    request = [37.611347, 55.760241]
    params = {'bbox': [36.83, 55.67, 38.24, 55.91]}
    expected = {'request': request, 'params': params}
...
def test_reverse_with_rspn_results_format_results_skip(httpx_mock: HTTPXMock):
    request = [37.611347, 55.760241]
    params = {'format': 'xml', 'results': 10, 'skip': 10}
    expected = {'request': request, 'params': params}
...
def test_reverse_with_all(httpx_mock: HTTPXMock):
    request = [37.611347, 55.760241]
    params = {
        'sco': 'latlong',
        'kind': 'street', 'rspn': True,
...
def test_getimage(httpx_mock: HTTPXMock):
    request = [37.611347, 55.760241]
    expected = 'test_getimage'
    httpx_mock.add_response(
        method='GET',
        url='%s?ll=%s&l=sat&lang=ru_RU' % 
            (StaticClient.BASE_URL, f'{request[0]},{request[1]}'),
        json=expected,
    )
    actual = StaticClient().getimage(request)
    assert actual.decode() == f'"{expected}"'


def test_getimage_with_l_z_scale_lang(httpx_mock: HTTPXMock):
    request = [37.611347, 55.760241]
    ...
    actual = StaticClient().getimage(request, **params)
    assert actual.decode() == f'"{expected}"'


def test_getimage_with_spn_size(httpx_mock: HTTPXMock):
    request =  [37.611347, 55.760241]
...
def test_getimage_with_pt_pl(httpx_mock: HTTPXMock):
    request = [37.611347, 55.760241]
    params = {
...
def test_getimage_with_all(httpx_mock: HTTPXMock):
    request = [37.611347, 55.760241]
    params = {
        'lang': 'tr_TR',
        'l': ['sat', 'skl', 'trf'] ,
